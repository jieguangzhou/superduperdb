...
class OpenAIImageCreation(_OpenAI):
    ...
    Examples:
        ...
        >>> model = OpenAIImageCreation(model='dall-e', prompt='a close up, studio photographic portrait of a {context}', response_format='url')
        >>> model.predict('cat')
...
class OpenAIImageEdit(_OpenAI):
    ...
    Examples:
        ...
        >>> model = OpenAIImageEdit(model='dall-e', prompt='A celebration party at the launch of {context}', response_format='url')
